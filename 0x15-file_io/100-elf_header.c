 ...
 * @e_ident: Array of ELF magic numbers.
 *
 * Description: Magic numbers with space delimeter
 */
 ...
 * @e_ident: Array containing the ELF OS
 * Return: void
 */
 ...
 * @e_type: ELF type
 * @e_ident: Array containing the ELF type
 */
 ...
 * @e_ident: Array containing the ELF EP
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	r = read(fo, header, sizeof(Elf64_Ehdr));
	if (r == -1)
	{
		free(header);
		close_elf(fo);
